...
$brochure_form   = get_field('brochure_form');
...
<p style="margin: 0 0 6px;"><strong>Message: </strong><br><?php echo $messages; ?></p>
						...
						<tr>
							<td class="one-column">
								<table width="100%">
									<tr>
										<td class="inner contents">
											<p>Hi,<strong><?php echo ucwords($full_name); ?></strong>,</p>
											<p class="h1">Thank you for contacting us. you can now reach us at customer@udbhata.com or call us at 
